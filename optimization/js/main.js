...
function updatePositions() {
    ...
    //Change from querySelectorAll('.mover')
    var items = document.getElementsByClassName('mover');
    //Created outside variables
    var phaseScroll = document.body.scrollTop;
    var phaseArray = [];

    //Create the for loops that generate placement of background pizzas and animate them onto the background
    for (var i = 0; i < 5; i++) {
        phaseArray.push(Math.sin((phaseScroll / 1250) + i));
    }
